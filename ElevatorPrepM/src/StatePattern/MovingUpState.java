...
public class MovingUpState implements ElevatorState {
    ...
    public void move(Elevator elevator) {
        ...
        System.out.println("Elevator " + elevator.getId() + " moving up to floor " + currentFloor);
    ...
    public void display(Elevator elevator) {
        System.out.println("Elevator " + elevator.getId() + " | Floor: " + elevator.getCurrentFloor() + " | MOVING UP");
    }
}